...
public class ConvertorHelper {
    ...
    private void StringDateRegister() {
        ...
        repository.registerConvertor(Date.class, String.class, sqlTimestampToString);
        ...
        repository.registerConvertor(Date.class, Long.class, dateToLong);
        ...
        repository.registerConvertor(Long.class, Date.class, longToDate);
