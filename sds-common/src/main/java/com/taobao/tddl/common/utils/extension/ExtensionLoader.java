...
/**
 * 包装{@linkplain java.util.ServiceLoader}，提供SPI的获取方式 <br/>
 * jdk自带的{@linkplain java.util.ServiceLoader}
...
public class ExtensionLoader<S> {
    ...
    /**
     * 获取所有的扩展类，按照{@linkplain com.taobao.tddl.common.utils.extension.Activate}定义的order顺序进行排序
     *
     * @return
     */
