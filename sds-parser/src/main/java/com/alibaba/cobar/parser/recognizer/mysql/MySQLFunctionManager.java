...
import com.alibaba.cobar.parser.ast.expression.primary.function.arithmetic.*;
import com.alibaba.cobar.parser.ast.expression.primary.function.bit.BitCount;
import com.alibaba.cobar.parser.ast.expression.primary.function.comparison.*;
import com.alibaba.cobar.parser.ast.expression.primary.function.datetime.*;
import com.alibaba.cobar.parser.ast.expression.primary.function.encryption.*;
...
import com.alibaba.cobar.parser.ast.expression.primary.function.info.*;
import com.alibaba.cobar.parser.ast.expression.primary.function.misc.*;
import com.alibaba.cobar.parser.ast.expression.primary.function.string.*;
...
public class MySQLFunctionManager {
    ...
    /**
     * @param extFuncPrototypeMap funcName -&gt; extFunctionPrototype. funcName MUST NOT be the same as predefined
     *                            function of MySQL 5.5
