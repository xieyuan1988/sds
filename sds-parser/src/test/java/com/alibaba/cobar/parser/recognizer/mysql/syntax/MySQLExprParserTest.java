...
public class MySQLExprParserTest extends AbstractSyntaxTest {
    ...
    public void testBitHex() throws Exception {
        ...
        expr = parser.expression();
        output = output2MySQL(expr, sql);
        Assert.assertEquals("_latin1 b''", output);
        Assert.assertEquals("", ((LiteralBitField) expr).getText());
        Assert.assertEquals("_latin1", ((LiteralBitField) expr).getIntroducer());
        ...
        Assert.assertEquals("", ((LiteralBitField) expr).getText());
        Assert.assertNull(((LiteralBitField) expr).getIntroducer());
        ...
        Assert.assertEquals("", ((LiteralHexadecimal) expr).getText());
        Assert.assertNull(((LiteralHexadecimal) expr).getIntroducer());
